...
<div class="wrapper tipoframe">
    ...
    <ul id="tabs" class="nav nav-tabs">
      <li class="active"><a data-toggle="tab" href="#home">Propiedades</a></li>
      <li><a data-toggle="tab" href="#menu1">Aplica a</a></li>
    </ul>
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-md-6">
                ...
                <table id="fuentes" class="table table-striped table-bordered font12" cellspacing="0" >
                    ...
                    <tbody>
                        <?php $c = 0; foreach($l_fuen as $row){ ?>
                        <tr  onMouseOver="CambiaColor(this,'#dff0d8','blue')" onMouseOut="CambiaColor2(this,'#000000')">
                            <td><?php echo $row['fuen_deno']; ?></td>
                            <td style="text-align: center"> 
                                <label class="switch">
                                     <input type="checkbox" name="anota_fuen_f['<?php echo $c ?>']" id="anota_fuen_f<?php echo $row['fuen_id'] ?>" value="<?php echo $row['fuen_id'] ?>"  class="switch-input" 
                                            <?php if ($row['si_no'] == "S") {echo "checked";} ?> >
                                     <span class="switch-label" id="lopi" data-on="Si" data-off="No"></span>
                                     <span class="switch-handle"></span>
                                </label>
