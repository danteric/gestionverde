    		...
    		<tr class="<?php echo $class ?>">
    	      ...
    	      <td style="vertical-align: middle; width: 80px">
    				<?php if($_SESSION["usuario"]["modi"] == "S"){ ?>
    					<a class = "btn btn-mini" href="<?php echo url_for("abmProyecto/formularioProyecto?proy_id=".$row['proy_id']) ?>" data-content="Editar" data-toggle="popover" data-trigger="hover" data-placement="top">
    						<i class="icon icon-pencil text-success"></i>
    					</a>
    					<a class = "btn btn-mini" onclick="eliminarEntidad('<?php echo url_for("abmProyecto/baja?proy_id=".$row['proy_id']) ?>');" href="#" data-content="Eliminar" data-toggle="popover" data-trigger="hover" data-placement="top">
