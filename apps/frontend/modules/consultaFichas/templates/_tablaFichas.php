				...
				<tr class="<?php echo $class ?>">
					...
					<td>
						<?php if($_SESSION["usuario"]["modi"] == "S"){ ?>
							<a class = "btn btn-mini" href="<?php echo url_for("consultaFichas/formularioFichas?fich_id=".$row['fich_id']) ?>">
								<i class="icon icon-pencil text-success"></i>
							</a>
							<a class = "btn btn-mini" href="<?php echo url_for("consultaFichas/baja?fich_id=".$row['fich_id']) ?>">
