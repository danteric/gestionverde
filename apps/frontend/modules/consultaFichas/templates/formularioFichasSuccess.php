...
<script type="text/javascript">
    ...
    cancelar = function(){   //funcion para volver al clickear boton "volver"
        ...
        location.href = '<?php echo url_for("consultaFichas/consultaFichas") ?>';
    }
...
<form id="formulario" method="POST" action="<?php echo url_for("consultaFichas/formularioFichas") ?>">
<?php
		$cabecera = new cabecera();
		$cabecera->ruta(link_to(__("ConsultaFichas"),'consultaFichas/consultaFichas'));
                    ...
                    <table id="fases" class="table table-striped table-bordered font12" cellspacing="0" >
                        ...
                        <tbody>
                            ...
                            <tr  onMouseOver="CambiaColor(this,'#dff0d8','blue')" onMouseOut="CambiaColor2(this,'#000000')">
                                ...
                                <td style="text-align: center"> 
                                    <label class="switch">
                                         <input type="checkbox" onclick="return false" name="anota_fase_f['<?php echo $c ?>']" id="anota_fase_f<?php echo $row['fase_id'] ?>" value="<?php echo $row['fase_id'] ?>"  class="switch-input" 
                                                <?php if ($row['si_no'] == "S") {echo "checked";} ?> >
                                         <span class="switch-label" id="lopi" data-on="Si" data-off="No"></span>
                                         <span class="switch-handle"></span>
                                    </label>
                    ...
                    <table id="medios" class="table table-striped table-bordered font12" cellspacing="0" >
                        ...
                        <tbody>
                            ...
                            <tr  onMouseOver="CambiaColor(this,'#dff0d8','blue')" onMouseOut="CambiaColor2(this,'#000000')">
                                ...
                                <td style="text-align: center"> 
                                    <label class="switch">
                                         <input type="checkbox" onclick="return false" name="anota_medi_f['<?php echo $c ?>']" id="anota_medi_f<?php echo $row['medi_id'] ?>" value="<?php echo $row['medi_id'] ?>"  class="switch-input" 
                                                <?php if ($row['si_no'] == "S") {echo "checked";} ?> >
                                         <span class="switch-label" id="lopi" data-on="Si" data-off="No"></span>
                                         <span class="switch-handle"></span>
                                    </label>
                    ...
                    <table id="tamanio" class="table table-striped table-bordered font12" cellspacing="0" >
                        ...
                        <tbody>
                            ...
                            <tr  onMouseOver="CambiaColor(this,'#dff0d8','blue')" onMouseOut="CambiaColor2(this,'#000000')">
                                ...
                                <td style="text-align: center"> 
                                    <label class="switch">
                                         <input type="checkbox" onclick="return false" name="anota_tama_f['<?php echo $c ?>']" id="anota_tama_f<?php echo $row['tama_id'] ?>" value="<?php echo $row['tama_id'] ?>"  class="switch-input" 
                                                <?php if ($row['si_no'] == "S") {echo "checked";} ?> >
                                         <span class="switch-label" id="lopi" data-on="Si" data-off="No"></span>
                                         <span class="switch-handle"></span>
                                    </label>
                    ...
                    <table id="tipologia" class="table table-striped table-bordered font12" cellspacing="0" >
                        ...
                        <tbody>
                            ...
                            <tr  onMouseOver="CambiaColor(this,'#dff0d8','blue')" onMouseOut="CambiaColor2(this,'#000000')">
                                ...
                                <td style="text-align: center"> 
                                    <label class="switch">
                                         <input type="checkbox" onclick="return false" name="anota_tipo_f['<?php echo $c ?>']" id="anota_tipo_f<?php echo $row['tipo_id'] ?>" value="<?php echo $row['tipo_id'] ?>"  class="switch-input" 
                                                <?php if ($row['si_no'] == "S") {echo "checked";} ?> >
                                         <span class="switch-label" id="lopi" data-on="Si" data-off="No"></span>
                                         <span class="switch-handle"></span>
                                    </label>
