...
<script>
    ...
    $('#spinner').show();
    $.post("<?php echo url_for('datosEncuestas/traeDatosEncuestas') ?>",
    { 
     pagina: $('#pagina').val()
     }, 
        function(data){
...
<form id="examenesForm" class="form-horizontal" name="datosPersonalesForm" method="POST" action="<?php echo url_for("datosEncuestas/Grabar") ?>" >
<?php 
	$cabecera = new Cabecera();
	//$cabecera->titulo(__("Confirmacion de datos personales"));
	$cabecera->ruta('Datos para encuestas');
