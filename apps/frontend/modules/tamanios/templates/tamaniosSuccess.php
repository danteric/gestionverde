    ...
    <table border="0" frame="" class="tablesorter responsiveWidth table table-striped table-bordered">
        ...
        <tbody>
                ...
                <tr onMouseOver="CambiaColor(this,'#dff0d8','blue')" onMouseOut="CambiaColor2(this,'#000000')">
                    <td><?php echo $row['tamanio_id']; ?></td>
                    <td><?php echo $row['tamanio_deno']; ?></td>
                    <td><?php echo $row['tamanio_deno_redu']; ?></td>
                    <td style="text-align: center">
                        <?php if($_SESSION["usuario"]["modi"] == "S"){ ?>
                            <a class = "btn btn-mini" href="<?php echo url_for("tamanios/formularioTamanios?tamanio_id=".$row['tamanio_id']) ?>">
                                <i class="icon icon-pencil text-success"></i>
                            </a>
                            <a class = "btn btn-mini" onclick="eliminarEntidad('<?php echo url_for("tamanios/baja?tamanio_id=".$row['tamanio_id']) ?>');" href="#">
