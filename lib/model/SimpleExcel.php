...
class SimpleExcel
{
     ...
     * @return  void
     */
    public function addRow($values,$tipo = 'String'){
        $row = &$this->tabl_data;
        $row .= '
...
//            $value = filter_var($value, FILTER_SANITIZE_SPECIAL_CHARS);
             ...
             if ($datatype == 'DateTime') : $isdate = ' ss:StyleID="s1"'; else : $isdate = ''; endif;
            $row .= '
    <Cell'.$isdate.'><Data ss:Type="'.$datatype.'"><![CDATA['.$value.']]></Data>
    </Cell>';
        }
