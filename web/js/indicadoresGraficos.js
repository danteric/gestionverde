  ...
  $.fn.evento = function(options){
    ...
    return this.each(function(){
      ...
      $this.hover(function(){
        ...
        var $tipDom = $('<div class="tip"><div class="tip-inner"><div class="tip-content"><div class="tip-msg button2">'+ data.msg +'</div></div></div><div class="arrow arrow-back"></div><div class="arrow arrow-front"></div></div>');
        ...
        $tip.addClass(data.piel).css({ top : top }).fadeIn(300);
...
function pieChart() {
  ...
  var sliceBorderWidth = 4;                         // Width (in pixels) of the border around each slice
  ...
  var pullOutLabelFont = "bold 15px 'Trebuchet MS', Verdana, sans-serif";  // Pull-out slice label font
  var pullOutValueFont = "bold 15px 'Trebuchet MS', Verdana, sans-serif";  // Pull-out slice value font
  ...
  var pullOutShadowBlur = 15;                        // How much to blur the pull-out slice shadow
  ...
  function drawSlice ( context, slice ) {
    ...
    context.shadowColor = ( slice == currentPullOutSlice ) ? pullOutShadowColour : "#DDEA13";
    context.fill();
...
/************************************************************************/
$(".presion").live("click", function(){
		var operaid=$(this).attr("data");
		var operacontador=$(this).attr("data2");
        cargarGrillaAnual(operaid,operacontador);
